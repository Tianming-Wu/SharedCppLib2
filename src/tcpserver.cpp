...
scl2::bytearray server_client_handler::read(size_t bytes)
{
...
scl2::bytearray server_client_handler::readAll()
{
...
size_t server_client_handler::write(const scl2::bytearray &data)
{
